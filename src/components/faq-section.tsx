...
const FAQS = [
  { q: '婵梦科技是做什么的？', a: '婵梦科技是AI驱动的合伙制企业增长全链路平台。我们服务企业客户、内部合伙人与外部合伙人，通过AI工具、增长体系与合伙机制，推动流量获客、商业转化、品牌出海和事业成长。' },
  { q: '核心服务有哪些？', a: '核心服务包括流量获客与商业转化、AI工具与效率赋能、品牌出海与跨境增长，并通过合伙人生态连接人才、能力与业务机会。' },
